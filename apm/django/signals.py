...
class DjangoSignals:
    def init():
        request_started.connect(DjangoSignals.start_tracked_request, dispatch_uid='request_started_scoutapm')
        request_finished.connect(DjangoSignals.stop_tracked_request, dispatch_uid='request_stopped_scoutapm')
